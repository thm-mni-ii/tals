...
/**
 * Provides service to update students attendance for given appointment
 *
 * @package     mod_tals
...
$PAGE->set_url('/mod/tals/editstudent.php', ['id' => $cm->id]);
...
redirect(new moodle_url('/mod/tals/reportdetail.php', ['id' => $id, 'appid' => $appid]));