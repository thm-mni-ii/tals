...
$string['label_report'] = 'Bericht (aktuelle Woche wird hier nicht erfasst)';
...
$string['label_has_no_pin'] = 'Veranstatlung ohne PIN Abfrage.';
$string['label_future_appointment'] = 'Termin hat noch nicht angefangen.';
$string['label_past_appointment'] = 'Termin hat bereits stattgefunden.';
...
$string['label_download_title'] = 'Als .csv datei herunterladen';
$string['label_hour'] = 'Uhr';
$string['label_cancel'] = 'Abbrechen';
$string['label_close'] = 'Schließen';
$string['label_activate'] = 'Aktivieren';
